...
const [accountVariant, setAccountVariant] = useState("");
...
return (
    <div>
        ...
        <select
            ...
            onChange={(event) => {
                setAccountVariant(event.target.value)
            }}
        >
            <option value="">Välj typ av skattekonto</option>
            <option value="ISK">ISK</option>
            <option value="AF">Aktie/Fond</option>
